namespace System.Linq; // расширенное пространство имен от Microsoft
public static class MyLinqExtensions
{
    //цепной метод расширения LINQ
    public static IEnumerable<T> ProcessSequence<T>(
    this IEnumerable<T> sequence)
    {
        // здесь можно выполнить процесс обработки
        return sequence;
    }
    ...
    // скалярный метод расширения LINQ
